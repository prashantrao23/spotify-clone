...
const Sidenav = () => {
    ...
    return (
        <nav className='left-section flex flex-col gap-y-2 max-w-[420px] min-w-[320px] w-[100%]  overflow-hidden relative'>{/*overflow-y-hidden max-h-screen*/}
            ...
            <div className='absolute h-28 w-48 bg-slate-300 left-full top-0 z-100 createplaylist'></div>
